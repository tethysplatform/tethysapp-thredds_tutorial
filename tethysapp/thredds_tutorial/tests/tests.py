...
class ThreddsTutorialTestCase(TethysTestCase):
    ...
    def set_up(self):
        ...
        test database creation function here, like so:
            ...
            self.create_test_persistent_stores_for_app(ThreddsTutorial)
    ...
    def tear_down(self):
        ...
        stores, you should call the test database destruction function from here, like so:
            ...
            self.destroy_test_persistent_stores_for_app(ThreddsTutorial)
    ...
    def test_home_controller(self):
        ...
        response = c.get('/apps/thredds-tutorial/')  # The final '/' is essential for all pages/controllers
